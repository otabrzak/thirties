...
In the previous strategy, we only decided to keep sixes and fives. Could we improve our strategy by computing the expected value of the next turn based on number of dice kept? Let's try to estimate the maximal value thrown by n dice, since we only need to keep 1 die.
